...
public class DataImpl implements Data {
	...
	private void controlInput(final int day, final int month, final int year) {
		if (year < 1900) {
			throw new IllegalArgumentException(
					"L'anno no può essere inferiore al 1900");
		}
		...
		if (day < 1) {
			...
			if (year % 4 == 0) {
				if (day > 29) {
					throw new IllegalArgumentException(
							"Il giorno non puo' essere maggiore di 29");
				}
			} else {
				if (day > 28) {
					throw new IllegalArgumentException(
							"Il giorno non puo' essere maggiore di 28");
				}
			}

		} else if (Arrays.asList(4, 6, 9, 11).contains(month) && day > 30) {
			throw new IllegalArgumentException(
					"Il giorno non puo' essere maggiore di 30");

		} else if (day > 31) {
			throw new IllegalArgumentException(
					"Il giorno non puo' essere maggiore di 31");
		}
