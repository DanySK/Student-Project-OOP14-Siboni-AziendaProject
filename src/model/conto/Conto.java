...
public interface Conto extends Serializable {
	...
	static enum Tipo{
		...
		ECONOMICO_DI_REDDITO("Economico Di Reddito"),
		ECONOMICO_DI_CAPITALE("Economico Di Capitale");
	...
	static enum AccesoA{
		...
		RICAVI_ES("Ricavi d'Esercizio",Tipo.ECONOMICO_DI_REDDITO),
		RICAVI_SOSP("Ricavi Sospesi",Tipo.ECONOMICO_DI_REDDITO),
		RICAVI_PLUR("Ricavi Pluriennali",Tipo.ECONOMICO_DI_REDDITO),
		PATRIMONIO_NETTO("Patrimonio Netto",Tipo.ECONOMICO_DI_CAPITALE);
